// example/lib/main_full_debug_app.dart
...
void main() {
  runApp(const FullDebugAppExample());
}

/// Example to use for debugging the permissions.
class FullDebugAppExample extends StatefulWidget {
  const FullDebugAppExample({super.key});

  @override
  State<FullDebugAppExample> createState() => _FullDebugAppExampleState();
}

class _FullDebugAppExampleState extends State<FullDebugAppExample> {
